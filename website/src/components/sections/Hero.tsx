          ...
          <div className="flex justify-center lg:justify-end">
            <div className="bg-white/10 backdrop-blur-md rounded-2xl border border-white/20 p-6 shadow-2xl w-full max-w-md">
              <div className="flex items-center gap-3 mb-6">
                ...
                <h3 className="text-white font-semibold text-lg">Get Your Quote</h3>
              </div>
              
              <div className="space-y-4">
                <div>
                  <label className="block text-white/80 text-sm font-medium mb-2">Pick-up Location</label>
                  <div className="relative">
                    <MapPin className="absolute left-3 top-1/2 transform -translate-y-1/2 w-5 h-5 text-white/60" />
                    <input
                      type="text"
                      placeholder="Enter pickup location"
                      className="w-full bg-white/20 border border-white/30 rounded-lg pl-10 pr-4 py-3 text-white placeholder-white/60 focus:border-white/60 focus:outline-none focus:ring-2 focus:ring-white/20"
                    />
                  </div>
                </div>
                ...
                <div>
                  ...
                  <div className="relative">
                    ...
                    <input
                      type="date"
                      className="w-full bg-white/20 border border-white/30 rounded-lg pl-10 pr-4 py-3 text-white focus:border-white/60 focus:outline-none focus:ring-2 focus:ring-white/20"
                    />
                  </div>
                </div>
              </div>
              ...
              <div className="mt-6">
                <div className="text-white/80 text-sm mb-4">
                  <span className="text-white font-medium">Popular destinations:</span> London, Birmingham, Manchester
                </div>
                <Link
                  href="/contact"
